...
from app.web.app_helper import initialize_session_state, load_budget_file, load_simplifi_file, build_analyzer
...
def main():
    ...
    with st.sidebar:
        ...
        if simplifi_file is not None:
            load_simplifi_file(simplifi_file)
    ...
    if st.session_state.actual_data is None:
        ...
        build_analyzer(start_month, end_month)
